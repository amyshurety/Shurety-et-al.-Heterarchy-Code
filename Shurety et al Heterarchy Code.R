...
## Step 5: Plot the heterarchy matrix using the theoretical networks
...
## Step 6: Calculate Network Metric for a real world network 
...
##Step 7: Calculate the PHS for a Real world network
...
#Step 8: Correct for size in real-world networks
...
#Step 9: Standardise in real-world networks
...
##Step 10: Plot the real-world network on the heterarchy framework 
...
##Step 11: Calculate the Euclidean distance of each network from the Centre of the heterarchy matrix and 
...
##Step 12: Calculate the angle (degrees) of each network from the Centre of the heterarchy matrix 
